    ...
    >
      ...
      <el-form-item label="经费卡号" style="width: 48%">
        <el-input
          ...
          :disabled="dialogVisibleTitle == '查看经费'"
          @input="
            peoperForm.moneyCardId = peoperForm.moneyCardId.replace(
              /[^\d]/g,
              ''
            )
          "
      ...
      <el-form-item label="批复金额" style="width: 48%">
        <el-input
          ...
          :disabled="dialogVisibleTitle == '查看经费'"
          @input="
            peoperForm.allocate = peoperForm.allocate.replace(/[^\d]/g, '')
          "
        />
      </el-form-item>
      <el-form-item label="执行金额" style="width: 48%">
        <el-input
          ...
          :disabled="dialogVisibleTitle == '查看经费'"
          @input="
            peoperForm.execute = peoperForm.execute.replace(/[^\d]/g, '')
          "
        />
      </el-form-item>
      <el-form-item label="完成比例" style="width: 48%">
        <el-input
          ...
          :disabled="dialogVisibleTitle == '查看经费'"
          @input="
            peoperForm.proportion = peoperForm.proportion.replace(
              /[^\d]/g,
              ''
            )
          "
  ...
  methods: {
    ...
    carImgChange(e) {
      ...
      if (this.fileType == 0) {
        ...
        this.apiPostJson('yearEntity/savebody', form).then((res) => {
          if (res.code == 200) {
            this.$message({
              message: '文件上传成功',
              type: 'success'
