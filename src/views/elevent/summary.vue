  ...
  <div class="general_box">
    ...
    <div class="general_table">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="total" label="问题总数" />
        <el-table-column prop="oneContent" label="第一个落实方面问题内容" />
        <el-table-column prop="oneNumber" label="第一个落实方面问题数" />
      ...
      >
        <div>
          ...
          >
            ...
            <el-form-item label="问题总数" style="width: 48%">
              <el-input v-model="peoperForm.total" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="第一个落实方面问题内容" style="width: 48%">
              <el-input v-model="peoperForm.oneContent" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="第一个落实方面问题数" style="width: 48%">
              <el-input v-model="peoperForm.oneNumber" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="第二个落实方面问题内容" style="width: 48%">
              <el-input v-model="peoperForm.twoContent" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="第二个落实方面问题数" style="width: 48%">
              <el-input v-model="peoperForm.twoNumber" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="第三个落实方面问题内容" style="width: 48%">
              <el-input v-model="peoperForm.threeContent" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="第三个落实方面问题数" style="width: 48%">
              <el-input v-model="peoperForm.threeNumber" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="第四个落实方面问题内容" style="width: 48%">
              <el-input v-model="peoperForm.fourContent" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="第四个落实方面问题数" style="width: 48%">
              <el-input v-model="peoperForm.fourNumber" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
          </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      peoperForm: {
        ...
        total: '', // 问题总数
        oneContent: '', // 第一个落实方面问题内容
        oneNumber: '', // 第一个落实方面问题数
        twoContent: '', // 第二个落实方面问题内容
        twoNumber: '', // 问第二个落实方面问题数
        threeContent: '', // 第三个落实方面问题内容
        threeNumber: '', // 第三个落实方面问题数
        fourContent: '', // 第四个落实方面问题内容
        fourNumber: '' // 第四个落实方面问题数
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    fileSeeDialog(row) {
      ...
      row.summaryBodyEntities.filter((item) => {
        item.name = item.filename
      })
      this.fileList = row.summaryBodyEntities
    },
    // 文件上传
    carImgChange(e) {
      console.log(e)
      ...
      if (this.fileType == 0) {
        ...
        this.apiPostJson('summary/savebody', form).then(
          (res) => {
            if (res.code == 200) {
              this.$message({
                message: '文件上传成功',
