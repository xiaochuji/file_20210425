  ...
  <div class="general_box">
    ...
    <div class="general_table">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="summary" label="问题概述" />
        <el-table-column prop="company" label="移交单位" />
        <el-table-column prop="time" label="移交时间" />
      ...
      >
        <div>
          ...
          >
            ...
            <el-form-item label="问题概述" style="width: 48%">
              <el-input v-model="peoperForm.summary" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="移交单位" style="width: 48%">
              <el-input v-model="peoperForm.company" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="移交时间" style="width: 48%">
              <el-date-picker
            ...
            <el-form-item label="是否对问题处置情况回复" style="width: 48%">
              <el-input v-model="peoperForm.reply" :disabled="dialogVisibleTitle == '查看概况'" />
            </el-form-item>
            <el-form-item label="是否办结" style="width: 48%">
...
export default {
  ...
  methods: {
    ...
    fileSeeDialog(row) {
      ...
      row.transferBodyEntities.filter((item) => {
        item.name = item.filename
      })
      this.fileList = row.transferBodyEntities
    },
    // 文件上传
    carImgChange(e) {
      console.log(e)
      ...
      if (this.fileType == 0) {
        ...
        this.apiPostJson('transfer/savebody', form).then(
          (res) => {
            if (res.code == 200) {
              this.$message({
                message: '文件上传成功',
