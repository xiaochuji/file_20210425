<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="code" label="家具编号" />
    ...
    >
      <el-form-item label="家具名称" style="width: 48%">
        <el-input
          v-model="peoperForm.name"
          :disabled="dialogVisibleTitle == '查看经费'"
        />
      </el-form-item>
      <el-form-item label="家具编号" style="width: 48%">
        <el-input
      ...
      <div v-if="fileList.length > 0 && fileId != ''" style="width: 100%">
